# execute in bash terminal -> FLASK_APP=day03/flask_ex.py flask run
# file name -> app.py --> all flask execute possibility
...
@app.route('/html')
def html():
    return "<h1> Ths is HTML h1 tag! </h1>"
...
def d_day():
    ...
    remain = finish - today
    return f'우리가 같이 있을 수 있는 시간이 이제 {remain}일 밖에 안남았다'
